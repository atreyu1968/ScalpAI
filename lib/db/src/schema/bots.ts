...
export const botsTable = pgTable("bots", {
  ...
  maxWeeklyDrawdownPercent: numeric("max_weekly_drawdown_percent", { precision: 5, scale: 2 }).notNull().default("10.00"),
  dailyPnl: numeric("daily_pnl", { precision: 18, scale: 8 }).notNull().default("0"),
  dailyPnlDate: date("daily_pnl_date"),
  weeklyPnl: numeric("weekly_pnl", { precision: 18, scale: 8 }).notNull().default("0"),
  weeklyPnlWeekStart: date("weekly_pnl_week_start"),
